...
Movie.destroy_all 
# music vieos: 
m1 = Movie.create!(title: 'The Black Flag', description: 'Official music video for The Black Flag by Ryan Leslie', genre: 'Music Video', year: 2013); 
...
m1_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_bf_mv_small_photo.jpg');
...
m9 = Movie.create!(title: 'Glassa Wata', description: 'Official music video for Glassa Wata by YLTI', genre: 'Music Video', year: 2018); 
  ...
  m9_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ylti_small_photo.jpg');
...
m2 = Movie.create!(title: 'Pearl Black', description: 'Official music video for Pearl Black by Mursa', genre: 'Music Video', year: 2017); 
  ...
  m2_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/mursa_small_photo.jpg');
...
m7 = Movie.create!(title: 'Outstanding', description: 'Official music video for Outstanding by Talib Kweli and Ryan Leslie', genre: 'Music Video', year: 2012); 
  ...
  m7_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/tk_o_mv_small_photo.jpg');
  # m7_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/TALIBKWELI_outstanding_photo.png');
    ...
    m8_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/wc_i_small_photo.jpg');
    ...
    m6 = Movie.create!(title: 'Carnival of Venice', description: 'Official music video for Carnival of Venice by Ryan Leslie', genre: 'Music Video', year: 2013); 
    ...
    m6_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rles_cv_mv_small_photo.jpg');
    ...
    p1_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_joa_small_photo.jpg');
    ...
    p6_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_cv_live_small_photo.jpg');
    ...
    p10 = Movie.create!(title: 'Whipped Cream - Genesis Tour', description: 'Whipped Cream Genesis tour promo', genre: 'performance', year: 2018); 
    ...
    p10_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/wc_gtour_small_photo.jpg');
    ...
    p5_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_stock_small_photo.jpg');
    ...
    # animation videos: 
    a1 = Movie.create!(title: 'The Kingdom of Akio', description: 'The original Trailer for The Kingdom of Akio (2013)', genre: 'animation', year: 2013); 
    ...
    a1_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_1_small_photo.jpg');
    ...
    a2_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ka_sia_small_photo.jpg');
    ...
    a3 = Movie.create!(title: 'The Kingdom of Akio - Trailer 3', description: 'The Kingdom of Akio trailer (2014)', genre: 'animation', year: 2014); 
    ...
    a3_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_releif_small_photo.jpg');
    ...
    a4 = Movie.create!(title: 'The Kingdom of Akio - Trailer 4', description: 'The Eye of Hiruko (2014)', genre: 'animation', year: 2014); 
    ...
    a4_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_eye_small_photo.jpg');
    ...
    a5 = Movie.create!(title: 'The Kingdom of Akio - 3D Conceptual Trailer', description: 'The Kingdom of Akio 3d conceptual trailer (rough)', genre: 'animation', year: 2015); 
    ...
    a5_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_3d_small_photo.jpg');
    ...
    a6_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_story_small_photo.jpg');
    ...
    a7 = Movie.create!(title: 'The Kingdom of Akio trailer', description: 'The original trailer for The Kingdom of Akio', genre: 'animation', year: 2013); 
    a7_video = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Animation_Videos/KOA_trailer_animation_video.mp4');
    a7.video.attach(io: a7_video, filename: 'KOA_trailer_1_video'); 
    a7_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/ko_sia_small_photo_2.jpg');
    # a7_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/animation_photos/KOA_trailer_1_photo.png');
    a7.photo.attach(io: a7_photo, filename: 'KOA_trailer_1_photo'); 
    
    # Miscellaneous: 
    m3 = Movie.create!(title: 'Video Reel', description: 'Video reel by Anthony Kumasaka', genre: 'Miscellaneous', year: 2013); 
    ...
    m3_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/reel_small_photo.jpg');
    ...
    m4 = Movie.create!(title: 'Ready', description: 'A promo video for the song Ready by Fabolous featuring Kevin Hart and Jessica White', genre: 'Miscellaneous', year: 2013); 
    ...
    m4_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/fab_small_photo.jpg');
    ...
    m5 = Movie.create!(title: 'Min - Korea', description: 'A recap video of Ryan Leslie in Korea featuring Min', genre: 'Miscellaneous', year: 2013); 
    ...
    m5_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/min_small_photo.jpg');
    ...
    p7 = Movie.create!(title: 'Ryan Leslie - Sizzle Reel', description: 'Ryan leslie 2013 Sizzle Reel', genre: 'Miscellaneous', year: 2013); 
    ...
    p7_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_sizzle_small_photo.jpg');
    ...
    p8 = Movie.create!(title: 'Ryan Leslie - Black Mozart Tour', description: 'Ryan leslie 2014 Black Mozart Tour', genre: 'Miscellaneous', year: 2014); 
    ...
    p8_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/rl_tour_small_photo.jpg');
    ...
    p3 = Movie.create!(title: 'Jordan Comolli - Live in Rotterdam', description: 'Jordan Comolli live in Rotterdam', genre: 'Miscellaneous', year: 2018); 
    ...
    p3_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/jc_small_photo.jpg');
    ...
    m10 = Movie.create!(title: 'Element', description: 'Official music video for Element by Zak Downtown', genre: 'Miscellaneous', year: 2017); 
    ...
    m10_photo = open('https://s3-us-west-1.amazonaws.com/kumaflix-movies/Photos/small_photos/zd_element_small_photo.jpg');
